package ac.mdiq.podcini.sync.wifi
...
import ac.mdiq.podcini.sync.model.EpisodeActionChanges
import ac.mdiq.podcini.sync.model.ISyncService
import ac.mdiq.podcini.sync.model.SubscriptionChanges
import ac.mdiq.podcini.sync.model.SyncServiceException
import ac.mdiq.podcini.sync.model.UploadChangesResponse
    ...
    companion object {
        ...
        fun startInstantSync(hostPort_: Int = 54628, hostIp_: String="", isGuest_: Boolean = false) {
            ...
            LockingAsyncExecutor.executeLockedAsync {
                ...
                val builder: OneTimeWorkRequest.Builder = OneTimeWorkRequest.Builder(WifiSyncService::class.java).setBackoffCriteria(BackoffPolicy.EXPONENTIAL, 10, TimeUnit.MINUTES)
