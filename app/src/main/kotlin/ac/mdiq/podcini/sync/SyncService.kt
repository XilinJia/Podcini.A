...
import ac.mdiq.podcini.sync.SynchronizationSettings.password
import ac.mdiq.podcini.sync.SynchronizationSettings.username
...
import ac.mdiq.podcini.sync.nextcloud.NextcloudSyncService
import ac.mdiq.podcini.sync.queue.SynchronizationQueueStorage
...
//        }
    ...
    private fun getActiveSyncProvider(): ISyncService? {
        ...
        val selectedService = SynchronizationProviderViewData.fromIdentifier(selectedSyncProviderKey ?: "")
